...
public class LikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.likeActivityRecyclerView);
        ...
        new MusicaServerAPICalls() {
            ...
            public void isRequestSuccessful(boolean isSuccessful, String message) {
                if (isSuccessful) {
                    ...
                    Toast.makeText(getBaseContext(), "There was an error while updating like user status...", Toast.LENGTH_SHORT).show();
                }
            }
        }.getUserWhoLikedPost(getBaseContext(),POST_ID);
